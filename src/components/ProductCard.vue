...
<template>
  <div
    class="item-container flex flex-col justify-between items-center gap-2 shadow-xl rounded-xl cursor-pointer p-3 my-4"
    @click="handleSelectItem"
  >
    <img
      :src="getImageUrl(item)"
      alt="Imagem de comida"
      class="item-img w-[120px] h-[120px] rounded-lg"
    >
